        ...
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 h-full">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 flex-shrink-0">
            <Card className="border-l-4 border-blue-500 shadow-md hover:shadow-lg transition-shadow">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 p-3 sm:p-4">
                <CardTitle className="text-xs sm:text-sm font-medium text-gray-600">Submissions</CardTitle>
                <FileText className="h-4 w-4 text-blue-500" />
              </CardHeader>
              <CardContent className="p-3 sm:p-4 pt-0">
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#14213d]">0</div>
                <p className="text-xs text-gray-500 mt-0.5">Papers</p>
              </CardContent>
            </Card>

            <Card className="border-l-4 border-green-500 shadow-md hover:shadow-lg transition-shadow">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 p-3 sm:p-4">
                <CardTitle className="text-xs sm:text-sm font-medium text-gray-600">Accepted</CardTitle>
            ...
            <Card className="border-l-4 border-yellow-500 shadow-md hover:shadow-lg transition-shadow">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 p-3 sm:p-4">
                <CardTitle className="text-xs sm:text-sm font-medium text-gray-600">Review</CardTitle>
            ...
            <Card className="border-l-4 border-[#fca311] shadow-md hover:shadow-lg transition-shadow">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 p-3 sm:p-4">
                <CardTitle className="text-xs sm:text-sm font-medium text-gray-600">Payments</CardTitle>
                <CreditCard className="h-4 w-4 text-[#fca311]" />
              </CardHeader>
              <CardContent className="p-3 sm:p-4 pt-0">
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#14213d]">0</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 flex-1 min-h-0">
            <Card className="shadow-md border-l-4 border-[#fca311] hover:shadow-lg transition-all flex flex-col">
              <CardHeader className="bg-gradient-to-r from-[#14213d] to-[#1a2844] text-white p-3 sm:p-4 pb-2">
              ...
              <CardContent className="pt-3 sm:pt-4 p-3 sm:p-4 bg-gradient-to-br from-white to-blue-50 flex-1 flex flex-col">
                <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3 flex-1">No submissions yet</p>
                <Button className="w-full bg-[#fca311] hover:bg-[#ff9800] text-white text-xs sm:text-sm py-1.5 sm:py-2" asChild>
            ...
            <Card className="shadow-md border-l-4 border-[#fca311] hover:shadow-lg transition-all flex flex-col">
              ...
              <CardContent className="pt-3 sm:pt-4 p-3 sm:p-4 bg-gradient-to-br from-white to-blue-50 flex-1 flex flex-col">
                <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3 flex-1">No payments</p>
            ...
            <Card className="shadow-md border-l-4 border-green-500 hover:shadow-lg transition-all flex flex-col">
              <CardHeader className="bg-gradient-to-r from-green-700 to-green-900 text-white p-3 sm:p-4 pb-2">
                <CardTitle className="flex items-center gap-1 sm:gap-2 text-sm sm:text-base">
