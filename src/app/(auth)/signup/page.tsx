        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="flex items-center justify-center mb-4">
            <div className="bg-[#FFCC5C]/20 backdrop-blur-sm p-3 rounded-full ring-2 ring-[#FFCC5C]/50">
              <UserPlus className="h-10 w-10 text-[#FFCC5C]" />
            </div>
          </div>
          <h1 className="text-4xl font-bold mb-2">
            Join <span className="text-[#FFCC5C]">AdComSys 2026</span>
          </h1>
        ...
        <CardContent className="bg-linear-to-br from-blue-50 to-blue-100 rounded-b-3xl">
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="text-center text-sm text-gray-700">
              ...
              <Link href="/login" className="text-[#FFCC5C] hover:text-[#ff9800] hover:underline font-medium">
                Sign in
              </Link>
            </div>
          </form>
